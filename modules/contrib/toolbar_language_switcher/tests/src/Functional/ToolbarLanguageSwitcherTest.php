...
class ToolbarLanguageSwitcherTest extends BrowserTestBase {
  ...
  /**
   * Test use toolbar_language_switcher permission.
   */
  ...
  /**
   * Installs the provided languages.
   *
   * @param array $languages
   *   An array of language codes to be installed.
   *
   * @throws \Drupal\Core\Entity\EntityStorageException
   */
  public function installLanguages(array $languages) {
