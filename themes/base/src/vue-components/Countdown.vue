...
<template>
  <div 
    v-if="showCountdown"
    class="base-theme-countdown"
    :class="`base-theme-countdown--style-${countdownStyle}`">
    <div class="base-theme-countdown__container">
      <div 
        v-for="(num, index) in currentDiff" 
        :key="index"
        class="base-theme-countdown-item">
        <span class="base-theme-countdown-item__num">{{ num }}</span>
        <span class="base-theme-countdown-item__text">
