...
class __TwigTemplate_44d2812b33c1e31c26e3f6dd6c32c721 extends Template
{
...
($context["page"] ?? null), "header", [], "any", false, false, true, 48)))))) {
  ...
  ";
        // line 61
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "highlighted", [], "any", false, false, true, 61)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 62
  ...
  ";
        // line 69
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "tabs", [], "any", false, false, true, 69)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 70
  ...
  ";
        // line 77
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty(Twig\Extension\CoreExtension::trim($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "banner_top", [], "any", false, false, true, 77))))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 78
  ...
  ";
        // line 83
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty(Twig\Extension\CoreExtension::trim($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "breadcrumbs", [], "any", false, false, true, 83))))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 84
  ...
  ";
        ...
        if ((($tmp =  !($context["node"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 92
            yield "    ";
            if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty(Twig\Extension\CoreExtension::trim($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "page_title", [], "any", false, false, true, 92))))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 93
  ...
  <main role=\"main\" class=\"main container\">
    ...
    ";
        // line 114
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty(Twig\Extension\CoreExtension::trim($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "sidebar", [], "any", false, false, true, 114))))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 115
  ...
  ";
        // line 128
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty(Twig\Extension\CoreExtension::trim($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "footer", [], "any", false, false, true, 128))))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 129
  ...
  ";
    ...
    {
        return new Source("", "core/profiles/demo_umami/themes/umami/templates/layout/page.html.twig", "/Users/jie.zhou/web/Drupal/drupal-paragraphs/core/profiles/demo_umami/themes/umami/templates/layout/page.html.twig");
    }
